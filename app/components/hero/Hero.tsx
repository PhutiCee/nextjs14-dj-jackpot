...
export default function Hero() {
    return (
        <div className="relative h-full bg-gray-800 dark:bg-gray-900">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full max-w-7xl mx-auto px-5 py-6">
                <div className="flex flex-col items-center text-center lg:w-2/3 w-full">
                    <Image
                        ...
                        width={400}
                        height={400}
                        className="lg:w-2/5 md:w-3/6 w-5/6 mb-5 object-cover object-center rounded-xl"
                    />
